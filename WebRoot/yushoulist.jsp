...
<body>
    ...
    <div class="breadcrumbs">
        <div class="container_12">
            <div class="grid_12">
                <a href="index.do">首页</a><span></span><a href="#">预售商品</a>
            </div><!-- .grid_12 -->
        </div><!-- .container_12 -->
    </div><!-- .breadcrumbs -->
    ...
    <section id="main">
        <div class="container_12">
			...
			<a class="list" href="javascript:void(0)"><span></span></a>
                ...
                <c:forEach items="${list}" var="product">
                    <article class="grid_3 article">
                        ...
                        <h3 class="title" style="font-weight: bold;">${product.productname}<br>人气:${product.vote}</h3>
                        <div class="cart">
                            <div class="price">
                                <div class="vert">
                                                                                     ￥${product.price}
                                 <c:if test="${product.isys eq 'yes'}">                                                   
                                 <div style="font-size:4px;font-weight: bold;">预售</div> 
                                 </c:if>
                                </div>
                            </div>
			...
			<a href="yushouProduct.do?index=1" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
			</li>
			...
			<c:choose>
            <c:when test="${index >1}">
            <a href="popularityProduct.do?index=${index-1}" style="font-family:楷体;">上一页</a>
            </c:when>
            <c:otherwise>
            ...
            <a href="popularityProduct.do?index=${index+1}" style="font-family:楷体;">下一页</a>
            </c:when>
            <c:otherwise>
			...
			<li >
			<a href="popularityProduct.do?index=${pages}" style="font-family:楷体;">末页</a>
			</li>
		    </ul>
                </div><!-- .pagination -->
