...
<body>
    ...
    <div class="breadcrumbs">
        <div class="container_12">
            <div class="grid_12">
                <a href="index.do">首页</a><span></span><a href="#">人气排行</a>
            </div><!-- .grid_12 -->
        </div><!-- .container_12 -->
    </div><!-- .breadcrumbs -->
    ...
    <section id="main">
        <div class="container_12">
                        ...
                        <div class="cart">
                            <div class="price">
                                ...
                                <c:if test="${product.isxs eq 'yes'}">                                                   
                                 <div style="font-size:4px;font-weight: bold;">限时出售</div> 
                                 </c:if>
                                </div>
                            </div>
			...
			<a href="popularityProduct.do?index=1" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
			</li>
