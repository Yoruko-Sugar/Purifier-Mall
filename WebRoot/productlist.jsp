    ...
    <section id="main">
        <div class="container_12">
		    ...
		    <div class="grid-list">
		    	<nav class="primary">
                    <ul>
                        <li class="curent"><a href="product_List_Asc.do?categoryid=${categoryid}">升序</a></li>
                        <li class="curent"><a href="product_List_Desc.do?categoryid=${categoryid}">降序</a></li>
                    </ul>
                 </nav> 
		    </div><!-- .grid-list -->
			...
			<div class="grid_6">
				...
				<a href="productDetails.do?id=${product.id}"><h3 class="title">${product.productname}</h3></a>
                                <p> 
                                <c:choose>
                                  <c:when test="${fn:length(product.jdcontent)>80}">${fn:substring(product.jdcontent, 0, 75)}</c:when>
                                  <c:otherwise>${product.jdcontent}</c:otherwise>
                                </c:choose>
