      ...
      <div class="row">
        ...
        <div class="col-sm-7 text-right text-center-xs">                
          <ul class="pagination pagination-sm m-t-none m-b-none">
            ...
            <a href="inventoryList.do?index=1&key=${key}&key1=${key1}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
            
            <c:choose>
            <c:when test="${index >1}">
            <a href="inventoryList.do?index=${index-1}&key=${key}&key1=${key1}" style="font-family:楷体;">上一页</a>
            </c:when>
            <c:otherwise>
            ...
            <a href="inventoryList.do?index=${index+1}&key=${key}&key1=${key1}" style="font-family:楷体;">下一页</a>
            </c:when>
            <c:otherwise>
            ...
            &nbsp;&nbsp;
            <a href="inventoryList.do?index=${pages}&key=${key}&key1=${key1}" style="font-family:楷体;">末页</a>
            </li>
          </ul>
        </div>
      </div>
