      ...
      <table class="table table-striped b-t b-light">
        ...
        <c:forEach items="${list}" var="category" varStatus="status">
          <tr>
            <td>${category.name}</td>
            <td>
              <a href="showCategory.do?id=${category.id}" title="编辑" class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a>
      ...
      <div class="row">
        ...
        <div class="col-sm-7 text-right text-center-xs">                
          <ul class="pagination pagination-sm m-t-none m-b-none">
            ...
            <a href="categoryList.do?index=1&key=${key}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
            
            <c:choose>
            <c:when test="${index >1}">
            <a href="categoryList.do?index=${index-1}&key=${key}" style="font-family:楷体;">上一页</a>
            </c:when>
            <c:otherwise>
            ...
            <a href="categoryList.do?index=${index+1}&key=${key}" style="font-family:楷体;">下一页</a>
            </c:when>
            <c:otherwise>
            ...
            &nbsp;&nbsp;
            <a href="categoryList.do?index=${pages}&key=${key}" style="font-family:楷体;">末页</a>
            </li>
          </ul>
        </div>
      </div>
