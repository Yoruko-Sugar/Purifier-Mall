          ...
          <tr>
            ...
            <td>
              <c:choose>
                ...
                <a href="productEdit.do?id=${product.id}&issj=no" title="no" class="active" ui-toggle-class=""><i>下架</i></a>
                </c:when>
                <c:otherwise>
                <a href="productEdit.do?id=${product.id}&issj=yes" title="no" class="active" ui-toggle-class=""><i>上架</i></a>
                </c:otherwise>
              </c:choose>
              <c:if test="${product.isys eq 'no'}">
              <a href="updateIsys.do?id=${product.id}&type=no" title="no" class="active" ui-toggle-class="">取消预售</a>
              </c:if>
              <c:if test="${product.isys eq 'yes'}">
              <a href="updateIsys.do?id=${product.id}&type=yes" title="yes" class="active" ui-toggle-class="">预售</a>
              </c:if>
