...
<body>
    ...
    <section id="main">
        <div class="container_12">
			...
			<h3 style="color: red; font-weight: bold;">￥${total} <br></h3><br><br><br><br><br><br><br><h3 style="color: red; font-weight: bold;">
			<form class="contact" action="alipay/index.jsp" method="post" name="orderForm">
			<input type="submit" height="" value="支付宝入口" name="button1"></form>
			</h3>
