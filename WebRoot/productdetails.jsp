        ...
        <div class="container_12">
			...
			<div class="entry_content">
				...
				<div class="availability_sku">
					...
					点赞: ${product.vote}<a href="javascript:void(0)" onclick="toupiao('${product.id}')"><img alt="" src="/jingshuiqi/images/toupiao.jpg" style="width: 30px;height: 30px;"></a> 
				    </div>
				    
				    <c:forEach items="${svlist}" var="servicer">
				    <div class="availability">
					${servicer.name}: <font style="color:#6F8921"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${servicer.qq}&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:${servicer.qq}:42" alt="点击这里给我发消息" title="点击这里给我发消息"></a></font>
				    </div>
				    </c:forEach>
                            ...
                            <div class="parameter_selection" style="height: 80px;">${product.jdcontent}
			    </div><!-- .parameter_selection -->

			    <div class="cart">
			    				<c:if test="${product.isys eq 'yes'}">                                                   
                                 <a href="javascript:addCart('${product.id}')" class="bay"><img src="img/bg_cart.png" alt="Buy" title="">点击预售购买</a> 
                                 </c:if>
...
<c:if test="${msg eq 'message'}">
  <script type="text/javascript">
  layer.msg("已点赞,不能重复操作");
  </script>
</c:if>
