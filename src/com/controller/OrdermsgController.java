...
public class OrdermsgController extends BaseController {
	...
	public String orderList(HttpServletRequest request){
		...
		for(int a=0;a<fklist.size();a++ ){
			...
			Address address = addressDAO.findbyid(Integer.parseInt(fklist.get(a).getAddrid()));
		...
		for(int i=0;i<fhlist.size();i++ ){
			...
			Address address = addressDAO.findbyid(Integer.parseInt(fhlist.get(i).getAddrid()));
			fhlist.get(i).setAddress(address);
		...
		for(int b=0;b<shlist.size();b++ ){
			...
			Address address = addressDAO.findbyid(Integer.parseInt(shlist.get(b).getAddrid()));
		...
		for(int c=0;c<wclist.size();c++ ){
			...
			Address address = addressDAO.findbyid(Integer.parseInt(wclist.get(c).getAddrid()));
	...
	public String adminorderList(HttpServletRequest request){
		...
		for(int i=0;i<list.size();i++){
			...
			Address address = addressDAO.findbyid(Integer.parseInt(list.get(i).getAddrid()));
